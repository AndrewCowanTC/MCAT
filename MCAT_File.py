...
if __name__ == "__main__":
    ...
    #                 print(MCAT_Class(c,ch,g,el,Country).a2())
    ...
    #             for ch in Chord:
    #                 print("Gauge: ",g," Class: ",c," Chord: ",ch," Cant: ",el)
    #                 print(MCAT_Class(c,ch,g,el,Country).a3())
    ...
    #             for ch in Chord:
    #                 print("Gauge: ",g," Class: ",c," Chord: ",ch," Cant: ",el)
    #                 print(MCAT_Class(c,ch,g,el,Country).a4())
    ...
    #             for ch in Chord:
    #                 print("Gauge: ",g," Class: ",c," Chord: ",ch," Cant: ",el)
    #                 print(MCAT_Class(c,ch,g,el,Country).a5())
    ...
    #             for ch in Chord:
    #                 print("Gauge: ",g," Class: ",c," Chord: ",ch," Cant: ",el)
    #                 print(MCAT_Class(c,ch,g,el,Country).a6())
    ...
    #             for ch in Chord:
    #                 print("Gauge: ",g," Class: ",c," Chord: ",ch," Cant: ",el)
    #                 print(MCAT_Class(c,ch,g,el,Country).a9())
    ...
    #             for ch in Chord:
    #                 print("Gauge: ",g," Class: ",c," Chord: ",ch," Cant: ",el)
    #                 print(MCAT_Class(c,ch,g,el,Country).a10())
    ...
    for el in Cant:
        for g in Gauge:
            for c in Class:
                for ch in Chord:
                    print("Gauge: ",g," Class: ",c," Chord: ",ch," Cant: ",el)
                    print(MCAT_Class(c,ch,g,el,Country).a11())